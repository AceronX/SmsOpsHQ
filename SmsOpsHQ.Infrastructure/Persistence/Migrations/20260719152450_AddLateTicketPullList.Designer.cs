...
namespace SmsOpsHQ.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260719152450_AddLateTicketPullList")]
    partial class AddLateTicketPullList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmsOpsHQ.Infrastructure.Persistence.Entities.CustomerAppNoteEntity", b =>
                {
                    b.Property<int>("CustomerAppNoteId")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("CustomerAppNoteId");

                    b.HasIndex("CreatedAtUtc");

                    b.HasIndex("CreatedByUserId");

                    b.HasIndex("StoreId", "CustomerKey");

                    b.ToTable("CustomerAppNotes", (string)null);
                });
            ...
            modelBuilder.Entity("SmsOpsHQ.Infrastructure.Persistence.Entities.LateTicketPullEntity", b =>
                {
                    b.Property<int>("LateTicketPullId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("StoreId", "TicketKey")
                        .IsUnique();

                    b.ToTable("LateTicketPulls", (string)null);
                });
            ...
            modelBuilder.Entity("SmsOpsHQ.Infrastructure.Persistence.Entities.ThreadEntity", b =>
                {
                    ...
                    b.HasIndex("StoreId", "TwilioNumberId", "ContactPhoneE164")
                        .IsUnique()
            ...
            modelBuilder.Entity("SmsOpsHQ.Infrastructure.Persistence.Entities.CustomerAppNoteEntity", b =>
                {
                    b.HasOne("SmsOpsHQ.Infrastructure.Persistence.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmsOpsHQ.Infrastructure.Persistence.Entities.StoreEntity", null)
                        .WithMany()
